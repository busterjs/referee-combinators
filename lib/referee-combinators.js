((typeof define === "function" && define.amd && function (m) {
    define(["lodash", "referee", "buster"], m);
}) || (typeof module === "object" && function (m) {
    module.exports = m(require("lodash"), require("referee"), require("buster"));
}) || function (m) { this.referee = m(this._, this.referee, this.buster); }
)(function (_, referee, buster) {
    "use strict";
    ...
    var partial = function (unappliedAssertion, daName) {
        var takesExpd = function () {
            ...
            takesActl.displayName = takesExpd.displayName + fmtArgs.apply(this, expected);
            return takesActl;
        };
