((typeof define === "function" && define.amd && function (m) {
    ...
    referee.add('next', {
        assert: function(actual, assertion) {
            return when(actual).
                then(function(val){
                    return  assertion.raw(_.head(val))}).
                then(function(val){
    ...
    referee.add('repeat', {
        assert: function(actual, assertion, stop) {
            function repeat(current) {
                return when(current).then(function(val) {
                    return when(stop.raw(val)).
                        then(function(toCheck){
                            return repeat(assertion.raw(toCheck))},
                            _.identity)
                });
            }
